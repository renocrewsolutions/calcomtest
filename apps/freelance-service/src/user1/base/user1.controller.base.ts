...
export class User1ControllerBase {
  ...
  async createUser1(@common.Body() data: User1CreateInput): Promise<User1> {
    return await this.service.createUser1({
      data: data,
      select: {
        bio: true,
        createdAt: true,
  ...
  async user1s(@common.Req() request: Request): Promise<User1[]> {
    const args = plainToClass(User1FindManyArgs, request.query);
    return this.service.user1s({
      ...args,
      select: {
        bio: true,
        createdAt: true,
  ...
  async user1(
    ...
    const result = await this.service.user1({
      where: params,
      select: {
        bio: true,
        createdAt: true,
  ...
  async updateUser1(
    ...
    try {
      return await this.service.updateUser1({
        where: params,
        data: data,
        select: {
          bio: true,
  ...
  async deleteUser1(
    ...
    try {
      return await this.service.deleteUser1({
        where: params,
        select: {
          bio: true,
          createdAt: true,
  ...
  async connectBids(
    ...
    await this.service.updateUser1({
      where: params,
      data,
      select: { id: true },
    });
