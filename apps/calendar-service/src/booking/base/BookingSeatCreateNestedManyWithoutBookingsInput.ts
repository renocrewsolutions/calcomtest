...
@InputType()
class BookingSeatCreateNestedManyWithoutBookingsInput {
...
export { BookingSeatCreateNestedManyWithoutBookingsInput as BookingSeatCreateNestedManyWithoutBookingsInput };
