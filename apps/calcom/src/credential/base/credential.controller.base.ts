...
import { CalendarCacheFindManyArgs } from "../../calendarCache/base/CalendarCacheFindManyArgs";
...
export class CredentialControllerBase {
  ...
  @common.Get("/:id/calendarCache")
  @ApiNestedQuery(CalendarCacheFindManyArgs)
  async findCalendarCache(
    @common.Req() request: Request,
    @common.Param() params: CredentialWhereUniqueInput
  ): Promise<CalendarCache[]> {
    const query = plainToClass(CalendarCacheFindManyArgs, request.query);
    const results = await this.service.findCalendarCache(params.id, {
      ...query,
      select: {
        credential: {
          select: {
  ...
  @common.Post("/:id/calendarCache")
  async connectCalendarCache(
    @common.Param() params: CredentialWhereUniqueInput,
    @common.Body() body: CalendarCacheWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      calendarCache: {
        connect: body,
  ...
  @common.Delete("/:id/calendarCache")
  async disconnectCalendarCache(
    @common.Param() params: CredentialWhereUniqueInput,
    @common.Body() body: CalendarCacheWhereUniqueInput[]
  ): Promise<void> {
    const data = {
