...
@InputType()
class AppRoutingFormsFormCreateNestedManyWithoutUsersInput {
...
export { AppRoutingFormsFormCreateNestedManyWithoutUsersInput as AppRoutingFormsFormCreateNestedManyWithoutUsersInput };
