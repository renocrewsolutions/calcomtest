...
@InputType()
class AppRoutingFormsFormCreateNestedManyWithoutTeamsInput {
...
export { AppRoutingFormsFormCreateNestedManyWithoutTeamsInput as AppRoutingFormsFormCreateNestedManyWithoutTeamsInput };
