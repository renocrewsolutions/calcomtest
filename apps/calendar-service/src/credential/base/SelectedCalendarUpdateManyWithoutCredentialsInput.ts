...
@InputType()
class SelectedCalendarUpdateManyWithoutCredentialsInput {
...
export { SelectedCalendarUpdateManyWithoutCredentialsInput as SelectedCalendarUpdateManyWithoutCredentialsInput };
