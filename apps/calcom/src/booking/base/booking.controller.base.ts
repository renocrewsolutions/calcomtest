...
import { BookingSeatFindManyArgs } from "../../bookingSeat/base/BookingSeatFindManyArgs";
...
export class BookingControllerBase {
  ...
  @common.Get("/:id/seatsReferences")
  @ApiNestedQuery(BookingSeatFindManyArgs)
  async findSeatsReferences(
    @common.Req() request: Request,
    @common.Param() params: BookingWhereUniqueInput
  ): Promise<BookingSeat[]> {
    const query = plainToClass(BookingSeatFindManyArgs, request.query);
    const results = await this.service.findSeatsReferences(params.id, {
      ...query,
      select: {
        attendee: {
          select: {
  ...
  @common.Post("/:id/seatsReferences")
  async connectSeatsReferences(
    @common.Param() params: BookingWhereUniqueInput,
    @common.Body() body: BookingSeatWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      seatsReferences: {
        connect: body,
  ...
  @common.Patch("/:id/seatsReferences")
  async updateSeatsReferences(
    @common.Param() params: BookingWhereUniqueInput,
    @common.Body() body: BookingSeatWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/seatsReferences")
  async disconnectSeatsReferences(
    @common.Param() params: BookingWhereUniqueInput,
    @common.Body() body: BookingSeatWhereUniqueInput[]
  ): Promise<void> {
    const data = {
