...
export class UserResolverBase {
  ...
  async createUser(@graphql.Args() args: CreateUserArgs): Promise<User> {
    return await this.service.createUser({
      ...
      data: {
        ...
        movedToProfile: args.data.movedToProfile
          ? {
              connect: args.data.movedToProfile,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => [OutOfOfficeEntry], { name: "bookingRedirects" })
  async findBookingRedirects(
    @graphql.Parent() parent: User,
    @graphql.Args() args: OutOfOfficeEntryFindManyArgs
  ): Promise<OutOfOfficeEntry[]> {
    const results = await this.service.findBookingRedirects(parent.id, args);
  ...
  @graphql.ResolveField(() => [OutOfOfficeEntry], {
  ...
  async findBookingRedirectsTo(
    ...
    const results = await this.service.findBookingRedirectsTo(parent.id, args);
  ...
  @graphql.ResolveField(() => [Host], { name: "hosts" })
  async findHosts(
    @graphql.Parent() parent: User,
    @graphql.Args() args: HostFindManyArgs
  ): Promise<Host[]> {
    const results = await this.service.findHosts(parent.id, args);
  ...
  @graphql.ResolveField(() => [EventType], { name: "ownedEventTypes" })
  async findOwnedEventTypes(
    @graphql.Parent() parent: User,
    @graphql.Args() args: EventTypeFindManyArgs
  ): Promise<EventType[]> {
    const results = await this.service.findOwnedEventTypes(parent.id, args);
  ...
  async getMovedToProfile(
    @graphql.Parent() parent: User
  ): Promise<Profile | null> {
    const result = await this.service.getMovedToProfile(parent.id);
  ...
  async getOrganization(@graphql.Parent() parent: User): Promise<Team | null> {
  ...
  @graphql.ResolveField(() => UserPassword, {
    nullable: true,
    name: "password",
  })
  async getPassword(
    ...
    const result = await this.service.getPassword(parent.id);
