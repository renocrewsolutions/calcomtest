...
export class AttendeeResolverBase {
  ...
  async createAttendee(
    ...
    return await this.service.createAttendee({
      ...
      data: {
        ...
        bookingSeat: args.data.bookingSeat
          ? {
              connect: args.data.bookingSeat,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => BookingSeat, {
    nullable: true,
    name: "bookingSeat",
  })
  async getBookingSeat(
    ...
    const result = await this.service.getBookingSeat(parent.id);
