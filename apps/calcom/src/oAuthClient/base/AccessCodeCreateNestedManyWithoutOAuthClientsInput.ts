...
@InputType()
class AccessCodeCreateNestedManyWithoutOAuthClientsInput {
...
export { AccessCodeCreateNestedManyWithoutOAuthClientsInput as AccessCodeCreateNestedManyWithoutOAuthClientsInput };
