...
@InputType()
class BookingUpdateManyWithoutDestinationCalendarsInput {
...
export { BookingUpdateManyWithoutDestinationCalendarsInput as BookingUpdateManyWithoutDestinationCalendarsInput };
